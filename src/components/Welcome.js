  ...
  return (
    <>
      <div className="flex justify-center px-5 pt-2">
        <div className="w-[50rem] italic text-white xs:mx-2 xs:my-8 sm:my-16 md:my-32">
          <h4 className="my-5 xs:text-3xl md:text-4xl">BendJS</h4>
          <h5 className="my-5 xs:text-2xl md:text-3xl">
            A Javascript meetup in Bend, Oregon
          </h5>
          ...
          <h5 className="xs:text-2xl sm:my-5 md:my-10 md:text-3xl">
